...
<div class="covmatrix">
  ...
  <div class="cm-row"><span class="cm-name">primeng</span><span class="cm-bar"><span class="cm-seg native" style="width:87%"></span><span class="cm-seg derived" style="width:3%"></span><span class="cm-seg approx" style="width:3%"></span><span class="cm-seg other" style="width:7%"></span></span></div>
  <div class="cm-row"><span class="cm-name">storybook</span><span class="cm-bar"><span class="cm-seg native" style="width:68%"></span><span class="cm-seg derived" style="width:16%"></span><span class="cm-seg approx" style="width:13%"></span><span class="cm-seg other" style="width:3%"></span></span></div>
  ...
  <div class="cm-row"><span class="cm-name">daisyui</span><span class="cm-bar"><span class="cm-seg native" style="width:32%"></span><span class="cm-seg derived" style="width:54%"></span><span class="cm-seg approx" style="width:9%"></span><span class="cm-seg other" style="width:5%"></span></span></div>
  <div class="cm-row"><span class="cm-name">bootstrap</span><span class="cm-bar"><span class="cm-seg native" style="width:23%"></span><span class="cm-seg derived" style="width:65%"></span><span class="cm-seg approx" style="width:2%"></span><span class="cm-seg other" style="width:10%"></span></span></div>
</div>
