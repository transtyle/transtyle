...
| [primeng/](primeng/)             | `npm run dev -w govuk-demo-primeng`       | 4307 | The same page in real PrimeNG components on Angular — the emitted preset is type-checked against PrimeNG's own `DesignTokens` types as part of `ng build` |
