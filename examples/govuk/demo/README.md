...
|---|---|---|---|
| [bootstrap/](bootstrap/) | `npm run dev -w govuk-demo-bootstrap` | 4301 | *Nimbus Console* in real Bootstrap 5.3, **Sass path** — `.btn-primary` & friends compiled from the GOV.UK theme |
...
| [echarts/](echarts/) | `npm run dev -w govuk-demo-echarts` | 4304 | *Nimbus Analytics* — a chart dashboard shelled in GOV.UK's blue |
