...
|---|---|---|---|
| [bootstrap/](bootstrap/) | `npm run dev -w carbon-demo-bootstrap` | 4401 | *Nimbus Console* in real Bootstrap 5.3, **Sass path** — `.btn-primary` & friends compiled from the Carbon theme |
...
| [echarts/](echarts/) | `npm run dev -w carbon-demo-echarts` | 4404 | *Nimbus Analytics* — a chart dashboard, Blue 60-anchored |
