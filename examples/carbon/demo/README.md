...
| [primeng/](primeng/)             | `npm run dev -w carbon-demo-primeng`       | 4407 | The same page in real PrimeNG components on Angular — the emitted preset is type-checked against PrimeNG's own `DesignTokens` types as part of `ng build` |
