...
**See it rendered:** [examples/demo-app/](../demo-app/) shows the same fake app themed by these outputs in daisyUI and shadcn (terminal-dark by default), next to Acme for contrast — open `examples/demo-app/index.html`.
