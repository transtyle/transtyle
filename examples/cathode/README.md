...
**See it rendered:** [demo/](demo/) contains the same five npm demo projects as Acme's (file-identical except `ds.config` — that's the point), terminal-dark by default: a phosphor-green Bootstrap, CRT shadcn/ui and daisyUI, a green-anchored ECharts dashboard, and a Storybook whose chrome boots dark. From the repo root:

```bash
npm run dev -w cathode-demo-bootstrap   # port 4201   (also: -daisyui 4202, -shadcn 4203, -echarts 4204, -storybook 6201)
```
