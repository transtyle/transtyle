...
- If a patch release *does* change theming behavior, the exporter ships a narrowed profile — the mechanism supports precision; we just don't promise it universally.
