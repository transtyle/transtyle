...
> **Status update 2026-07-23.** The core of this sketch has shipped ahead of the schedule below: two component-heavy exporters ([PrimeNG](exporters/primeng.md), [Bootstrap](exporters/bootstrap.md)) drive their targets' real component-theming surfaces, and a minimal shared catalog (`component.control.*`, `component.button.*`, `component.tooltip.max-width`) was generalized from where they demonstrably agree — [proposal 0003](../proposals/0003-component-catalog-generalization.md) and [proposal 0004](../proposals/0004-component-geometry.md), ADR-0003's [amendment](../adr/0003-tokens-first.md#amendment-2026-07-23-component-tier-pulled-into-the-first-alpha). 0004 also establishes that a catalog slot may declare **no default**: `tooltip.max-width` exists only when authored, because no semantic rung means "a readable measure" and inventing one would adopt a number on a single upstream's authority. The trap below is unchanged and permanent. What remains sketch is the breadth: the 15-component catalog, variant models, and state tokens described here are still not built.
