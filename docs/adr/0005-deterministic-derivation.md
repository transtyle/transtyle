...
- Cost accepted: rule packs will sometimes produce aesthetically mediocre values a human (or model) might beat; the answer is overriding, better rules in the next pack version — or AI *outside* the compiler writing config (VISION non-goal #5).
