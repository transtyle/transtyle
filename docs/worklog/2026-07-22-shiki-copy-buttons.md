...
Worse, two of the homepage snippets were **invalid DTCG** — `"primary": { "solid": "{option.color.blue.600}" }` omits `$value`, which every other page teaches correctly. Since the ask was that they be pasteable, they had to be *right* first.
