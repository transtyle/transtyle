...
## Process note
Both bugs were found by reproducing the maintainer's report live and measuring, not by re-reading my own CSS and reasoning about what it *should* do — the lesson from the last two rounds held.
